  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        lang: 'ja',
        theme_color: '#c6974f',
        background_color: '#c6974f',
        display: 'standalone',
        orientation: 'any',
        start_url: '/',
        scope: '/',
        icons: [
          { src: '/icon-192.png?v=20260809-2', sizes: '192x192', type: 'image/png' },
          { src: '/icon-512.png?v=20260809-2', sizes: '512x512', type: 'image/png' },
          { src: '/icon-512.png?v=20260809-2', sizes: '512x512', type: 'image/png', purpose: 'maskable' },
        ],
      },
      workbox: {
