...
- 再調査で、作成前に開いた講師窓の初回fetchとRealtime購読開始の間へINSERTが入る競合を確認。作成APIの戻り値から新規ID付きURLへ講師窓を切り替え、確定IDを直接表示するようにした。INSERT未受信状態の画面テストを含むVitest 66 files / 636 tests、TypeScript、ESLint、production buildが成功。
